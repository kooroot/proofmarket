...
pub mod proofmarket {
    ...
    pub fn create_market(
        ...
        instructions::create_market::handler(ctx, market_id, fixture_id, stat_a_key, stat_a_period, stat_b_key, stat_b_period, op, threshold, comparison, resolve_after_ts_ms, fee_bps)
    }
