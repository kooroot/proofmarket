...
| Standalone `validate_stat` vs the **real devnet txoracle** (golden proof → `Program return: … AQ==` TRUE, 205,300 CU) | [`3PwENbNm…`](https://explorer.solana.com/tx/3PwENbNmQBESsnzYWrrcEwGvqfug4ZWmHZeMr7PBRJxtoGUNbyoPPiG6VeDjxGGCA2ZQmNNpUysx2mLiYUMypTMy?cluster=devnet) · re-land via `scripts/land-validate-stat.ts` | ✅ **LIVE** (landed 2026-07-02) |
