      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-sm leading-6 text-zinc-500">
            Mainnet preview data shows only upcoming World Cup fixtures ordered
            by kickoff. Historical matches are reserved for deterministic replay
            receipts, while executable escrow and staking stay on devnet.
          </p>
        </div>
